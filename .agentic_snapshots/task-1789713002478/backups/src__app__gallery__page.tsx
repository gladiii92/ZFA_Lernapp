...
export default function GalleryPage() {
  ...
  return (
    <MobileContainer>
      ...
      <main className="flex-1 px-4 py-4 space-y-5 pb-28 overflow-y-auto text-slate-100">
        {/* Navigations-Rücksprung & Titel */}
        <div className="flex items-center justify-between">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-300 hover:text-white text-xs font-bold transition-all border border-slate-700/60 focus-visible:ring-2 focus-visible:ring-sky-400 outline-none"
          >
            <ArrowLeft className="w-4 h-4 text-sky-400" />
            <span>Zurück zur Startseite</span>
          </Link>
          <div className="flex items-center gap-1.5 text-[11px] bg-sky-500/10 border border-sky-500/30 text-sky-300 px-2.5 py-1 rounded-full font-bold">
            <Sparkles className="w-3.5 h-3.5 text-amber-300" />
            <span>8 Schaubilder</span>
          </div>
        </div>

        {/* Hero Header */}
        <div className="bg-gradient-to-br from-[#0f172a] via-[#0f172a] to-slate-900 border border-slate-800 rounded-3xl p-5 shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-1.5 bg-sky-500/15 border border-sky-500/30 px-3 py-1 rounded-full text-xs font-bold mb-2.5 text-sky-300">
              <Compass className="w-3.5 h-3.5 text-sky-400" />
              <span>Zentrale Grafik-Galerie • Galerie d&apos;illustrations</span>
            </div>

            <h1 className="text-xl font-black text-slate-100 tracking-tight leading-tight">
